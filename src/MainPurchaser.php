...
class MainPurchaser
{
    ...
    /**
     * @param  int  $purchaseUnitAmount
     * @return \Boatrace\Ninja\MainPurchaser
     */
    public function setPurchaseUnitAmount(int $purchaseUnitAmount): MainPurchaser
    {
        $this->purchaseUnitAmount = $purchaseUnitAmount;
    ...
    public function purchase(int $stadiumId, int $raceNumber, int $purchaseType, array $forecasts): void
    {
        ...
        $this->driver->findElement(WebDriverBy::id('amount'))->sendKeys($this->purchaseUnitAmount / 100);
        ...
        $this->driver->findElement(WebDriverBy::name('betAmount'))->sendKeys($this->purchaseUnitAmount * count($forecasts));
